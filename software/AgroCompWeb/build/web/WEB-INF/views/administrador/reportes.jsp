            ...
            <div class="container">
                ...
                <c:forEach items="${reporteList}" var="reporte">
                    <tr>
                        ...
                        <td>${reporte.descricao}</td>
                        <td>${reporte.dataHora}</td>
                        <td><a href="<c:url value="/reportes/${reporte.id}/deletar"/>" class="btn red"><i class="small material-icons">delete</i></a> </td>
                        <td> <a href="<c:url value="/anuncios/${reporte.anuncio.id}/deletar"/>" class="btn red"><i class="small material-icons">delete</i></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
