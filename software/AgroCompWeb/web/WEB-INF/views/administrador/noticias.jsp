            ...
            <table class="striped">
                ...
                <c:forEach items="${noticiaList}" var="noticia">
                    <tr>
                        ...
                        <td>${noticia.link}</td>                  
                        <td><a href="<c:url value="/noticias/${noticia.id}/editar"/>" class="btn blue"><i class="small material-icons">edit</i></a> </td>
                        <td> <a href="<c:url value="/noticias/${noticia.id}/deletar"/>" class="btn red"><i class="small material-icons">delete</i></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
