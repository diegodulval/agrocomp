        ...
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul>
                    ...
                    <li><a class="grey-text text-lighten-3" href="<c:url value="/forum"/>">Fórum</a></li>
                    <li><a class="grey-text text-lighten-3" href="<c:url value="/classificados"/>">Classificados</a></li>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <a class="#" href="#" title="Facebook">
                <i class="fa fa-github fa-2x right white-text"></i>
            </a>
            <a class="#" href="#" title="Facebook">
                <i class="fa fa-google-plus-official fa-2x right white-text"></i>
            </a>
            <a class="#" href="#" title="Facebook">
